...
use crate::{
    ...
    goldy_renderer::{
        AllocatorStats, FRAME_COUNTER, FRAME_PIPELINE_DEPTH, FrameFinishOutcome, FrameStats, GoldyShader,
        MAX_BUMP_RETRIES, PersistentState, PreparedFrame, PresentToken, ResourcePoolStats, defer_frame_gpu_resources,
        env_robust_override, sanitize_bump,
    },
...
impl<'a> SchemeRecorder<'a> {
    ...
    #[allow(
        dead_code,
        reason = "debug overlay uses GraphRecorder; kept for SchemeRecorder API parity"
    )]
